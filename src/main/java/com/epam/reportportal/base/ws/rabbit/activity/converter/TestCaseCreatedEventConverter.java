...
@Component
public class TestCaseCreatedEventConverter implements EventToActivityConverter<TestCaseCreatedEvent> {

  @Override
  public Activity convert(TestCaseCreatedEvent event) {
    return new ActivityBuilder()
        .addCreatedAt(event.getOccurredAt())
        .addAction(EventAction.CREATE)
        .addEventName(ActivityAction.CREATE_TEST_CASE.getValue())
  ...
  @Override
  public Class<TestCaseCreatedEvent> getEventClass() {
    return TestCaseCreatedEvent.class;
  }
}
